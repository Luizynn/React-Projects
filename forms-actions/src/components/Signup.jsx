...
import { isEmail, isEqualsToOtherValue, isNotEmpty, hasMinLength } from "../../../forms-app/src/util/validation";
...
export default function Signup() {
  ...
  function signupAction(prevFormState, formData){
    ...
    if(!isEqualsToOtherValue(password, confirmPassword)){
      errors.push('Both passwords must be equals, try again')
    }
    ...
    <form action={formAction}>
      ...
      <div className="control-row">
        ...
        <div className="control">
          ...
          <input 
            type="text" id="last-name" name="last-name" defaultValue={formState.enteredValues?.lastName}/>
        </div>
      </div>
