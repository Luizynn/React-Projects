            ...
            <ul>
                {
                    cartCtx.items?.map((item) => (
                        <CartItem key={item.id} name={item.name} quantity={item.quantity} price={item.price} increaseQuantity={() => cartCtx.addItem(item)} decreaseQuantity={() => cartCtx.removeItem(item.id)}/>
                    ))
                }
            </ul>
